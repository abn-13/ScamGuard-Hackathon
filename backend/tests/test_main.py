...
# DATABASE_URL is set in tests/conftest.py, which pytest loads before this (or any other)
# test module -- see the comment there for why it can't just be set here.
